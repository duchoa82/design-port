        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mb-8 w-full">
          {rowProjects.map((project, index) => (
            <div
              ...
              className={
                (index === 0
                  ? "h-[300px] sm:h-[350px] md:h-[400px] rounded-[8px] border border-border bg-portfolio-project-card transition-shadow duration-200 cursor-pointer flex flex-col flex-1 lg:flex-[2] p-3 sm:p-4 hover:shadow-[0_4px_24px_rgba(96,165,250,0.25)]"
                  : "h-[300px] sm:h-[350px] md:h-[400px] rounded-[8px] border border-border bg-portfolio-project-card transition-shadow duration-200 cursor-pointer flex flex-col flex-1 lg:flex-[1.5] p-3 sm:p-4 hover:shadow-[0_4px_24px_rgba(96,165,250,0.25)]") +
                " group"
              }
            >
              ...
              <div className="flex-1 flex flex-col justify-between w-full text-left">
                <h3 className="font-semibold text-foreground mb-2 text-sm sm:text-base text-left leading-tight">{project.title}</h3>
